...
namespace TravelBookingApp.Controllers
{
    public class CarsController : Controller
    {
        ...
        public CarsController(RihlaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cars != null ? 
                          ...
                          Problem("Entity set 'RihlaDbContext.Cars'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CarId,Make,Model,Year,DailyRate,City,Pickup,Dropoff,DropoffTime,PickupTime,Capacity,Availability")] Car car)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RihlaDbContext.Cars'  is null.");
            }
            var car = await _context.Cars.FindAsync(id);
            if (car != null)
            {

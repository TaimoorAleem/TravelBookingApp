...
public static class SampleHotelData
{
    public static List<Hotel> Hotels { get; } = new List<Hotel>
    {
        ...
        new Hotel { HotelId = 15, Name = "Business Hub Suites", Address = "13 Business District", Rating = 4.4, Description = "Convenience and comfort for business travelers.", NumberOfRooms = 200, Policies = new List<string> {"Conference facilities available", "Express check-in/check-out" },ImageUrls = new List<string> { "image29.jpg", "image30.jpg" }
